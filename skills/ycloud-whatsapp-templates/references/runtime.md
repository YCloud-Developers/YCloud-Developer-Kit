...
- [template-edit](https://docs.ycloud.com/reference/whatsapp_template-edit-by-name-and-language) — observed update label: about 2 months ago
- [template-list](https://docs.ycloud.com/reference/whatsapp_template-list) — observed update label: about 2 months ago
